...
function TableInfo() {
	...
	this.writeToTable = async (obj) => {
		...
		await XLSX.utils.sheet_add_aoa(this.worksheet, [["Дата", "PLN", "EUR", "Люди", "Титул", "Объект", "Бригады", "ФИО", "Комментарий"]], {origin: "A1"})

		this.worksheet["!cols"] = await [{wch: 15}, {wch: 15}, {wch: 15}, {wch: 20}, {wch: 20}, {wch: 15}, {wch: 25}, {wch: 50}, {wch: 50}];
